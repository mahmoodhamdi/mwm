...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    tags: [
      ...
      { name: 'Blog', description: 'Blog posts and categories management' },
      { name: 'Contact', description: 'Contact form and messages' },
      { name: 'Notifications', description: 'Push notifications and FCM topics' },
      { name: 'Newsletter', description: 'Newsletter subscribers and campaigns' },
      ...
      { name: 'Activity', description: 'Activity log tracking' },
